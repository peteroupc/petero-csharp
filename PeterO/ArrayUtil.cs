...
namespace PeterO {
  ...
  public static class ArrayUtil {
    ...
    private static int Mid<T>(
      IList<T> list,
      int ta,
      int tb,
      int tc,
      IComparer<T> comparer) {
      return (comparer.Compare(list[ta], list[tb]) < 0) ?
        (comparer.Compare(list[tb], list[tc]) < 0 ? tb :
         comparer.Compare(list[ta], list[tc]) < 0 ? tc : ta) :
        (comparer.Compare(list[tb], list[tc]) > 0 ? tb :
         comparer.Compare(list[ta], list[tc]) > 0 ? tc : ta);
    }

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.ArrayUtil.Sort(System.Int32[])"]/*'/>
    public static void Sort(int[] array) {
      if (array == null) {
        throw new ArgumentNullException("array");
      }
      var defarray = new
        DeferredArray<int>(array.Length);
      StableSortInternal(
        array,
 0,
 array.Length,
    ...
    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.ArrayUtil.Sort(System.Int32[],System.Int32,System.Int32)"]/*'/>
    public static void Sort(int[] array, int offset, int count) {
      if (array == null) {
        throw new ArgumentNullException("array");
      }
      if (offset < 0) {
      ...
      if (array.Length - offset < count) {
        throw new ArgumentException("array's length minus " + offset + " (" +
                    (array.Length - offset) + ") is less than " + count);
      }
      StableSortInternal(
        array,
 offset,
 count,
        Comparer<int>.Default,
        new DeferredArray<int>(array.Length));
    }

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.ArrayUtil.Sort``1(System.Collections.Generic.IList{``0})"]/*'/>
 ...
 list.Count,
        Comparer<T>.Default,
        new DeferredArray<T>(list.Count));
    }

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.ArrayUtil.Sort``1(System.Collections.Generic.IList{``0},System.Collections.Generic.IComparer{``0})"]/*'/>
 ...
 array.Count,
        comparer,
        new DeferredArray<T>(array.Count));
    }

    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.ArrayUtil.Sort``1(System.Collections.Generic.IList{``0},System.Int32,System.Int32)"]/*'/>
    public static void Sort<T>(IList<T> list, int offset, int count) where T :
      IComparable<T> {
      if (list == null) {
        throw new ArgumentNullException("list");
      }
 ...
 count,
    ...
    /// <include file='../docs.xml'
    /// path='docs/doc[@name="M:PeterO.ArrayUtil.Sort``1(System.Collections.Generic.IList{``0},System.Int32,System.Int32,System.Collections.Generic.IComparer{``0})"]/*'/>
